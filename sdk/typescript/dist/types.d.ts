 ...
 */
export type KnowledgeCategory = 'brand' | 'strategy' | 'meeting' | 'content' | 'technical' | 'relationship' | 'general';
/**
 ...
 */
export type EntityType = 'client' | 'person' | 'system' | 'service' | 'domain' | 'technology' | 'workflow' | 'agent';
/**
